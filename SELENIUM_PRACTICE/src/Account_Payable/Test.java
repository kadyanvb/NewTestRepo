...
//    // selectsearch.click();
      ...
      WebElement selectelement = driver.findElement(By.xpath("/html/body/div[2]/div/section[2]//*[@id='uiTable1']//*[@id='__toolbar0']//*[@id='__field0-F']//*[@id='__field0-I']"));
...
//    js.executeScript("arguments[0].click();",);
      ...
      actions.click(selectelement).perform();
      System.out.println("ELEMENT IS CLICKED");
      actions.sendKeys(new String [] {"AP081116000012"}).perform();
      
     // selectelement.click();
      System.out.println("DONE");
      driver.switchTo().parentFrame();
      
     // WebElement selectsearch= (WebElement) wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("sapMSFI")));
      //System.out.println("checkDispaly= "+selectsearch.isDisplayed());
      //System.out.println("checkEnable = "+selectsearch.isEnabled());
      
      
      
      System.out.println();
      //driver.findElement(By.xpath("//*[@id='__field0']//*[@id='__field0-F']//*[@id='__field0-I']"));
      
      //System.out.println("ELEMENT"+ selectsearch);
